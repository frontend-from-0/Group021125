...
4. Modern units:
  - Know dvh/svh/lvh for mobile viewport issues (address bar resizing).

5. Responsive images:
  - srcset / sizes, picture for art direction, lazy loading.

6. Touch + pointer awareness:
  - Don’t rely on hover; consider pointer: coarse, bigger hit targets.
